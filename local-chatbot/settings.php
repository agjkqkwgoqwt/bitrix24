<?php
define('C_REST_CLIENT_ID','local.65f99863b77ab9.17687286');//Application ID
define('C_REST_CLIENT_SECRET','9n6rVwgR9aDDu4wXkQTfoxTKJ2nZdsbhhxJiXJIGA0xwceEI2t');//Application key
// or
