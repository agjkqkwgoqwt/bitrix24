<?php
define('C_REST_CLIENT_ID','local.65f98f297ba645.20877989');//Application ID
define('C_REST_CLIENT_SECRET','lvWhgcoRZ0JeAOtxXknEwXtkelcDjH1mwWutZmvhs4sNH5Nk21');//Application key
// or
